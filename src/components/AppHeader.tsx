...
export default function AppHeader({ title, back = false, settings = false, onSettingsPress }: { title?: string; back?: boolean; settings?: boolean; onSettingsPress?: () => void }) {
...
const styles = StyleSheet.create({
  header: { alignItems: "center", flexDirection: "row", height: 68, justifyContent: "space-between", paddingHorizontal: 18 },
  iconButton: { alignItems: "center", height: 40, justifyContent: "center", width: 40 },
  title: { fontFamily: "WantedSansB", fontSize: 18 },
  logo: { height: 29, width: 110 },
});
